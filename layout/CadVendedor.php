                    ...
                    <div class="card-body" style="background-color: #DCDCDC;">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="text" id="rg" class="form-control" name="rg" placeholder="000.000.00">
                            </div>
                           ...
                           <div class="form-group col-3">
                            ...
                            <a href="../layout/VendedorBusca.php" class="btn btn-secondary">Buscar Vendedor</a>
                            <a href="../layout/Menu.php" class="btn btn-danger">Voltar ao  Menu</a>
