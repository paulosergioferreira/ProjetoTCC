...
<div class="container" id="tabela">
    <div class="card">
        <h5 class="card-header">Buscar Gerente</h5>
        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <?php else : ?>
                            ...
                            <?php foreach ($gc->findAll() as $g) : ?>
                                <tr>
                                    ...
                                    <a href="?d=<?= $g->id ?>" class="btn btn-danger" >Deletar</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                ...
                <a href="../layout/CadGerente.php" class="btn btn-danger btn-block">Cadastrar Gerentes</a>        
        </div>
    </div>
</body>
</html>